...
export default function AppError({ unstable_retry }: Props) {
  return (
    <div className="min-h-screen bg-gray-100 flex flex-col items-center justify-center text-center select-none p-8">
      <svg
